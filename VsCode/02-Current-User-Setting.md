...
```json
{
  ...
  "editor.guides.bracketPairs": "active", // Draws vertical lines connecting matching brackets
  "editor.letterSpacing": 0, // No extra space between letters
  "editor.renderLineHighlight": "none", // removes rectangular highlight

  // EDITOR CURSOR & SCROLLBAR
  "editor.cursorStyle": "line",
  "editor.cursorWidth": 3, // width of cursor
  ...
  "workbench.colorCustomizations": {
    "editor.background": "#191919", // keep your dark background
    "editorCursor.foreground": "#FFD700", // bright cursor color
    "editorLineNumber.foreground": "#555555", // normal lines
    "editorLineNumber.activeForeground": "#FFD700" // highlight current line number
  },
  "glassit.alpha": 220,
